## Práctica 3. Creación de RDD en PySpark

### Objetivo

Al finalizar la práctica, el estudiante sera capaz de iniciar la carga de datos en RDD a partir de diferentes fuentes de información directamente desde Visual Studio Code utilizando rutas relativas locales.

### Objetivo visual

![objetivo visual](../images/ov2.png)
...
![resultado](../images/lab2_resultado.png)
---
![resultado](../images/lab2_resultado2.png)
