## Práctica 6. Uso de funciones de transformación

### Objetivo

Al finalizar la práctica, el estudiante sera capaz de entender y aplicar funciones de transformación sobre RDDs de manera local y eficiente en Visual Studio Code, y configurar esquemas estructurados y procesar formatos CSV y Parquet de forma local.

### Objetivo visual

![objetivo visual](../images/ov5.png)
...
```
![lab5](../images/lab5_2.png)

!![lab5](../images/lab5_3.png)
...
spark.stop()
```
![lab5](../images/lab5_4.png)

![lab5](../images/lab5_5.png)
...
![resultado](../images/lab5_resultado.png)